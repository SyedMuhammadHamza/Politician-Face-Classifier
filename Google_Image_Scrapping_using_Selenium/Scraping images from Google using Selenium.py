# -*- coding: utf-8 -*-
"""
Created on Fri Jan 15 16:49:35 2021
...
driver_path= r'C:\Users\Hamza\Desktop\scraping\chromedriver.exe'
search_and_download(search_term,driver_path)

search_term='Xi Jinping'
search_and_download(search_term,driver_path)

search_term='Vladimir Putin'
search_and_download(search_term,driver_path)

search_term='Angela Merkel'
search_and_download(search_term,driver_path)
